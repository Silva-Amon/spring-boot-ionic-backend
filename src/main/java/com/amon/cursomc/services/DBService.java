...
public class DBService {
    ...
    public void instantiateDatabase() throws ParseException {
        ...
        Cliente cli1 = new Cliente(null, "Amon Silva", "amon.t.bernardo.s@gmail.com", "22222222", TipoCliente.PESSOAFISICA);
        ...
        Pedido ped1 = new Pedido(null, sdf.parse("2021/06/09 08:38"), cli1, e1);
        Pedido ped2 = new Pedido(null, sdf.parse("2021/07/09 08:39"), cli1, e2);
